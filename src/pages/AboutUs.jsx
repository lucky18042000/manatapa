        ...
        <div>
            ...
            <div className='homepagesection4'>
                ...
                <div className=' flex flex-col justify-center items-center w-[413px]' >
                    ...
                    <h1 className='lg:mt-[61px] mt-[20px] lg:text-[24px] font-semibold text-[#A80018] text-[20px]'>Associates  </h1>
            ...
            <div className='aboutussection3 '>
                ...
                <p className='pb-[42px] !w-max uppercase inline-flex items-center gap-3 font-medium lg:text-[20px] text-[10px]  text-[#A80018]'>
                    ...
                    <p className='lg:text-[18px] text-[14px]  text-[#A80018] leading-[19px] lg:leading-[29px] lg:mt-[61px] mt-[24px] w-[254px] lg:w-full text-center capitalize'>From the bustling streets of New York to the historic charm of London, we are across the USA and UK, soon to embrace the vibrant and diverse landscapes of India.</p>
                </div>
                <div className="absolute z-10 lg:right-[-100px] right-[15px] h-full flex items-center">
                    <img
            ...
            <div className='aboutussection4 '>
                ...
                <div className='flex lg:flex-row flex-col gap-[65px] justify-center mt-[54px]'>
                    ...
                    <p className={` lg:w-[75%] text-center text-[18px] text-[#A80018] leading-[29px] lg:mt-[61px] capitalize ${roslindaleFont.className}`}>
